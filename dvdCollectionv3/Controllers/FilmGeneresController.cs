...
namespace dvdCollection.Controllers
{
    public class FilmGeneresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GenereID,GenereDesc")] FilmGeneres filmGeneres)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GenereID,GenereDesc")] FilmGeneres filmGeneres)
        {
